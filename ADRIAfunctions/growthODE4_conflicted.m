...
<<<<<<< HEAD:ADRIAfunctions/growthODE4_conflicted.m
...
% Y(35, :) = P_x(35, :) .* X(34, :) .* r(34) - P_x(35, :) .* X(34, :) .* r(34) - X(35, :) .* mb(35);
>>>>>>> 0173acf4c2608b9d8e770efd5cf7b07db93d09e6:ADRIAfunctions/growthODE4.m
