...
Y(26:28, :) = P_x(26:28, :) .* X(25:27, :) .* r(25:27) - P_x(27:29, :) .*  X(26:28, :) .* r(26:28) - X(26:28, :) .* (mb(26) + comp .* X_tabular);
...
Y(32:35, :) = P_x(32:35, :) .* X(31:34, :) .* r(31:34) - P_x(33:36, :) .* X(32:35, :) .* r(32:35) - X(32:35, :) .* mb(32:35);
