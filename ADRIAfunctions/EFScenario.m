function results = EFScenario(x,interv, criteria, coral_params, sim_params, ...
...
%        https://doi.org/10.13140/RG.2.2.26976.20482
    ...
    prefseedsites = depth_priority(x(1:length(x)/2));
    prefshadesites = depth_priority(x((length(x)/2)+1:end));
