...
r_i = 1 - r;  %indicates the proportion of corals staying in a size class
% r_p = 1 + r; %now obsolete as we are only interested in growth
...
Y(5, :) = P_x(5, :) .* (X(5, :) .* r_i(5) + X(4, :) .* r(4)) - X(5, :) .* mb(5);
Y(6, :) = P_x(6, :) .* (X(6, :) .* r_i(6) + X(5, :) .* r(5)) + X(6, :) .* comp .* sum(X(25:30, :)) - X(6, :) .* mb(6);

%Tabular Acropora Unenhanced
Y(7, :) = P_x(7, :) .* X(7, :) .* rec(7, :) - X(7, :) .* (r(7)  + mb(7));
Y(8, :) = P_x(8, :) .* (X(8, :) .* r_i(8) + X(7, :) .* r(7)) - X(8, :) .* mb(8);
Y(9, :) = P_x(9, :) .* (X(9, :) .* r_i(9) + X(8, :) .* r(8)) - X(9, :) .* mb(9);
Y(10, :) = P_x(10, :) .* (X(10, :) .* r_i(10) + X(9, :) .* r(9)) - X(10, :) .* mb(10);
Y(11, :) = P_x(11, :) .* (X(11, :) .* r_i(11) + X(10, :) .* r(10)) - X(11, :) .* mb(11);
Y(12, :) = P_x(12, :) .* (X(12, :) .* r_i(12) + X(11, :) .* r(11)) + X(12, :) .* comp .* sum(X(25:30, :)) - X(12, :) .* mb(12);

%Corymbose Acropora Enhanced
Y(13, :) = P_x(13, :) .* X(13, :) .* rec(13, :) - X(13, :) .* (r(13) + mb(13));
Y(14, :) = P_x(14, :) .* (X(14, :) .* r_i(14) + X(13, :) .* r(13)) - X(14, :) .* mb(14);
Y(15, :) = P_x(15, :) .* (X(15, :) .* r_i(15) + X(14, :) .* r(14)) - X(15, :) .* mb(15);
Y(16, :) = P_x(16, :) .* (X(16, :) .* r_i(16) + X(15, :) .* r(15)) - X(16, :) .* mb(16);
Y(17, :) = P_x(17, :) .* (X(17, :) .* r_i(17) + X(16, :) .* r(16)) - X(17, :) .* mb(17);
Y(18, :) = P_x(18, :) .* (X(18, :) .* r_i(18) + X(17, :) .* r(17)) - X(18, :) .* mb(18);

%Corymbose Acropora Unenhanced
Y(19, :) = P_x(19, :) .* X(19, :) .* rec(19, :) - X(19, :) .* (r(19)  + mb(19));
Y(20, :) = P_x(20, :) .* (X(20, :) .* r_i(20) + X(19, :) .* r(19)) - X(20, :) .* mb(20);
Y(21, :) = P_x(21, :) .* (X(21, :) .* r_i(21) + X(20, :) .* r(20)) - X(21, :) .* mb(21);
Y(22, :) = P_x(22, :) .* (X(22, :) .* r_i(22) + X(21, :) .* r(21)) - X(22, :) .* mb(22);
Y(23, :) = P_x(23, :) .* (X(23, :) .* r_i(23) + X(22, :) .* r(22)) - X(23, :) .* mb(23);
Y(24, :) = P_x(24, :) .* (X(24, :) .* r_i(24) + X(23, :) .* r(23)) - X(24, :) .* mb(24);

%small massives Unenhanced
Y(25, :) = P_x(25, :) .* X(25, :) .* rec(25, :) - X(25, :) .* (r(25) + mb(25));
...
Y(31, :) = P_x(31, :) .* X(31, :) .* rec(31, :) - X(31, :) .* (r(31) + mb(31));
Y(32, :) = P_x(32, :) .* (X(32, :) .* r_i(32) + X(31, :) .* r(31)) - X(32, :) .* mb(32);
Y(33, :) = P_x(33, :) .* (X(33, :) .* r_i(33) + X(32, :) .* r(32)) - X(33, :) .* mb(33);
Y(34, :) = P_x(34, :) .* (X(34, :) .* r_i(34) + X(33, :) .* r(33)) - X(34, :) .* mb(34);
Y(35, :) = P_x(35, :) .* (X(35, :) .* r_i(35) + X(34, :) .* r(34)) - X(35, :) .* mb(35);
Y(36, :) = P_x(36, :) .* (X(36, :) .* r_i(36) + X(35, :) .* r(35)) - X(36, :) .* mb(36);
