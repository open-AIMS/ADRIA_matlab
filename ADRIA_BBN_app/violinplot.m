function violins = violinplot(data,axishandle,cats, varargin)
...
% This code is released under the terms of the BSD 3-clause license
    ...
    if isa(data, 'dataset') || isstruct(data) || istable(data)
        ...
        set(axishandle, 'XTick', 1:length(catnames), 'XTickLabels', catnames);
    ...
    elseif hascategories && numel(data) == numel(cats)
        ...
        set(axishandle, 'XTick', 1:length(catnames), 'XTickLabels', catnames_labels);
    ...
    elseif ismatrix(data)
        ...
        if hascategories && length(cats) == size(data, 2)
            set(axishandle, 'XTickLabels', cats);
        end
