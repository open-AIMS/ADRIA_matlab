function Y = Derive_StructuralComplexitySurvey(Indices)
% Parameter distributions obtained by surveying experts following RRAP 
% ES provisioning workshop in August 2021

surv_results = readtable('./Expert Data/Reef_Structual_Complexity_Results_processed.csv', 'PreserveVariableNames', true);
