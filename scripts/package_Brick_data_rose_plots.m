...
writetable(table1,strcat('scen1_table_Brickruns_',g,'.csv'))
...
writetable(table2,strcat('scen2_table_Brickruns_',g,'.csv'));
...
writetable(table3,strcat('scen3_table_Brickruns_',g,'.csv'));
...
writetable(table4,strcat('scen4_table_Brickruns_',g,'.csv'));
...
writetable(table5,strcat('scen5_table_Brickruns_',g,'.csv'));
...
writetable(table6,strcat('scen6_table_Brickruns_',g,'.csv'));
