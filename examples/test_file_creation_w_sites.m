...
F1 = multiBBNInf(Data, R, knownVars,inf_cells,increArray,nodePos,plotInd);
legend('year 1','year 5','year 9','year 13','year 17','year 21','year 25');

% compare with rcp 60
knownVars = [60,3,26,1,3,0.0009,0.0009];
F2 = multiBBNInf(Data, R, knownVars,inf_cells,increArray,nodePos,plotInd);
legend('year 1','year 5','year 9','year 13','year 17','year 21','year 25');
