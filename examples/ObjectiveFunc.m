function out = ObjectiveFunc(x,algInd,prSites,RCP,optInd,CrtWts,params,eco_parms)
...
reef_condition_metrics = runADRIA(Interv,CrtWts,params,eco_parms,algInd);
...
if (sum(optInd(1:3)) > 0)&&(sum(optInd(4:end)) == 0)
    ...
    av_S = mean(reef_condition_metrics.E,'all');
