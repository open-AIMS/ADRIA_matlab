...
for al = 1:3
    ...
    % simulations
    alg_cont_TC{1,al} = mean(mean(processed.TC(:,:,:,:),4),2);
    alg_cont_E{1,al} = mean(mean(processed.E(:,:,:,:),4),2);
    alg_cont_S{1,al} = mean(mean(processed.S(:,:,:,:),4),2);
end
...
for nn = 1:4
    for mm = 1:2
     for k =1:3
        hold on
        subplot(2,4,count)
        plot(1:25,alg_cont_TC{1,k}(:,count))
...
for nn = 1:4
    for mm = 1:2
     for k =1:3
        hold on
        subplot(2,4,count)
        plot(1:25,alg_cont_E{1,k}(:,count))
        legend('alg1','alg2','alg3')
        hold off
     end
     count = count+1;
...
for nn = 1:4
    for mm = 1:2
     for k =1:3
        hold on
        subplot(2,4,count)
        plot(1:25,alg_cont_S{1,k}(:,count))
        legend('alg1','alg2','alg3')
        hold off
     end
     count = count+1;
